...
import { Box, Typography, Container, Divider, Link, Stack, useTheme } from "@mui/material";
  ...
  return (
    <Box
      ...
      sx={{
        ...
        px: 2,
        mt: "auto",
        backgroundColor: theme.palette.mode === "light" ? "background.paper" : "background.paper",
